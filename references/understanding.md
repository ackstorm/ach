...
- **agent fleet**: `AgentProfile` (infra template: resources,
  ...
  config-hash re-pinned after merge; `achagent.placement` standalone|distributed, agent-overridable — distributed
