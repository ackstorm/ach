...
# Output: deploy/helm/ach/templates/install.yaml
#
...
OUTPUT="${2:-deploy/helm/ach/templates/install.yaml}"
...
# CRDs are canonical in deploy/helm/ach/crds/ (Phase 7 D-03). The
...
if command -v helm >/dev/null 2>&1; then
    echo "kustomize-to-helm.sh: running 'helm template deploy/helm/ach/' self-check..."
