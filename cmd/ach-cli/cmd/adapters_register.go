...
// Blank-import the 5 v1alpha1 closed-set adapter subpackages so each
...
// v1alpha1. pimono is the optional 5th adapter (Phase 5). Adding a
// further adapter requires a new subpackage AND a new line here;
// removing requires updating the autodetect message constants. Both
// are deliberate friction surfaces — the closed-set posture is the
// contract.
