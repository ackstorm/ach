...
// RC2); the spike re-run against 1.83.10 verified this endpoint now
// returns 202 cleanly (see 01-01-SUMMARY.md spike-rerun note).
func (c *RESTClient) CreateMCPServer(ctx context.Context, req *MCPServerRequest) (*MCPServerEntry, error) {
...
func (c *RESTClient) UpdateMCPServer(ctx context.Context, req *MCPServerUpdateRequest) (*MCPServerEntry, error) {
...
func (c *RESTClient) DeleteMCPServer(ctx context.Context, serverID string) error {
